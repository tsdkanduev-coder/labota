  ...
  private buildRealtimeConversationContext(providerCallId: string): RealtimeConversationContext {
    ...
    if (rawPrompt) {
      ...
      const instructions = [
        ...
        "Пример №1:",
        "* Начало диалога от тебя: здравствуйте, хотел бы забронировать столик на завтра на 20 00, на двоих. Подскажите, будут свободные столики?",
        "* Ответ сотрудника: да, конечно, на какое имя забронировать?",
        "* Ответ от тебя: на имя Елена.",
        "* Ответ сотрудника: отлично, забронировали, ждем вас.",
        "* Диалог закончен - ты заканчиваешь звонок.",
        "Пример №2:",
        "* Начало диалога от тебя: здравствуйте, хотел бы забронировать столик на завтра на 20 00, на двоих. Подскажите, будут свободные столики?",
        "* Ответ сотрудника: нет, к сожалению, нет. Но можем завтра на 19 если удобно.",
        "* Ответ от тебя: понял, давай уточню и перезвоню вам.",
        "* Ответ сотрудника: хорошо, ждем.",
        "* Диалог закончен - ты заканчиваешь звонок.",
      ].join("\n");
